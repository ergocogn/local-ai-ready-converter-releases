...
An official [Pandoc 3.9](https://hackage.haskell.org/package/pandoc-3.9) source archive is included in the new candidate package; this alone does not settle the legal question of combining it with this proprietary application. Before public distribution, compliance of **all** packaged components, including native dependencies, must be checked and described in the Release notes.
