...
| **First Windows Release** | Not published. Separate private distribution repository; no proprietary source in it. | After approval only: installer, bilingual notes, required third-party notices/sources and checksums. Configure public distribution without exposing the development repository. |
