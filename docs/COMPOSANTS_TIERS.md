...
Pandoc a été retiré du nouveau build Windows ; la licence GPL de Pandoc ne conditionne donc plus la distribution de ce paquet. Avant une distribution publique, la conformité des **autres** composants, notamment des dépendances natives de Tesseract, doit être vérifiée et explicitée dans les notes de Release.
